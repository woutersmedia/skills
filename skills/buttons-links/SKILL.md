...
name: buttons-links
description: >
  Optional project-specific skill. Use when the project provides shared <Button> and
  <AppLink> UI components. Enforces use of these components over raw <button>, <a>, and
  Next.js <Link> tags. Apply when asked to add or update buttons, links, or navigation
  in a project that uses this component system.
metadata:
  internal: true
---
